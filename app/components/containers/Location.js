...
import { basicPage, educationPage } from '../../reducers/currentPageReducer';
...
class Location extends React.Component {
    ...
    submitHandler(event) {
        ...
        let elements = document.getElementById('locationForm').elements;
    ...
    render() {
        ...
        return (
            <div>
                ...
                <form onSubmit={this.submitHandler} id="locationForm">
                    ...
                    <select
                        ...
                        <option value="Other">Other / Not United States</option>
                    </select>
